...
export async function generateMetadata({
  ...
  if (!post) {
    return {
      ...
      description:
        "The blog post you're looking for was not found on Quantum International Services.",
    };
  }
  ...
  return (
    <>
      <div className="container pt-32 pb-16 text-[#00204E]">
        ...
        <p className="flex flex-wrap gap-2 mb-4 mt-10">
          {post.short_description}
        </p>
        <div className="flex flex-wrap items-center gap-2 mb-6 text-sm">
          <p className="text-[#00204E] whitespace-nowrap">
